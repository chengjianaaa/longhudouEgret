window.skins={};
	...
	function BetTable() {
		_super.call(this);
		this.skinParts = ["table","ratioHe1","ratioLong","ratioHu","betCoin","time","timeNotice","alarmGroup","notice1","longRes","notice1Group","notice2","notice2Group","notice3","huRes","notice3Group"];
	...
	_proto.alarmGroup_i = function () {
		...
		t.x = 559.32;
		t.y = 580.68;
		t.elementsContent = [this._Image1_i(),this.time_i(),this.timeNotice_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
	...
	return VSliderSkin;
})(eui.Skin);generateEUI.paths['resource/eui_skins/modal/AlertSkin.exml'] = window.alertLogin = (function (_super) {
	__extends(alertLogin, _super);
	function alertLogin() {
		_super.call(this);
	...
	var _proto = alertLogin.prototype;
	...
	return alertLogin;
})(eui.Skin);generateEUI.paths['resource/eui_skins/modal/InfoPanal.exml'] = window.alertLogin = (function (_super) {
	__extends(alertLogin, _super);
	function alertLogin() {
		_super.call(this);
	...
	return alertLogin;
})(eui.Skin);generateEUI.paths['resource/eui_skins/modal/Loading.exml'] = window.alertLogin = (function (_super) {
	__extends(alertLogin, _super);
	function alertLogin() {
		_super.call(this);
		this.skinParts = ["loop","poker","rect","label","image","light"];
		...
		eui.Binding.$bindProperties(this, [495.08],[],this._Object3,"x");
		eui.Binding.$bindProperties(this, [450.55],[],this._Object3,"y");
	}
	var _proto = alertLogin.prototype;
